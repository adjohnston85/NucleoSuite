...
def test_pns_cli_defaults_to_raw_tracks_and_zero_gap():
    from nucleosuite.cli.main import build_parser
...
def test_pns_cli_exposes_bns_as_optional_scoring_method():
    from nucleosuite.cli.main import build_parser

    args = build_parser().parse_args([
        "pns", "--bam", "sample.bam", "--scoring-method", "bns"
    ])
    assert args.scoring_method == "bns"
    assert args.pns_tracks == ["pns", "posPNS"]


def test_pns_cli_exposes_tns_as_optional_scoring_method():
    from nucleosuite.cli.main import build_parser
