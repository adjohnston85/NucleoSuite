...
track. PNS is the default signal label.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--signal", "--bigwig", action="append", default=[], metavar="NAME=BIGWIG", help="PNS, WPS, or other BigWig for FFT analysis; repeat for multiple samples.")
    parser.add_argument("--signal-type", choices=("pns", "wps", "other"), default="pns", help="Signal label used in metadata and plot text (default: pns).")
